...
class LTimetablePage extends StatefulWidget {
  LTimetablePage({@required this.userDetails});
  final userDetails;
  static const String id = '/timetable';
  @override
  _LTimetablePageState createState() => _LTimetablePageState();
}

class _LTimetablePageState extends State<LTimetablePage> {
